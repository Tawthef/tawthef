    ...
    const handleAddToPool = async (candidateId?: string) => {
        if (!candidateId) {
            toast({
                ...
                description: "This row has no linked candidate.",
                variant: "destructive",
            });
            return;
        }
                            ...
                            <div key={scoreData.id} className="relative">
                                ...
                                <div className="mt-2 flex justify-end">
                                    <Button
                                        ...
                                        variant="outline"
                                        onClick={() => {
                                            void handleAddToPool(scoreData.candidate_id);
                                        }}
                                        disabled={actionCandidateId === scoreData.candidate_id}
                                    >
                                        {actionCandidateId === scoreData.candidate_id ? (
